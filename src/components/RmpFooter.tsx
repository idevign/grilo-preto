  ...
  return (
    ...
    >
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 1.5rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
            <nav aria-label="RMP footer navigation">
              <ul style={{ listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                {navLinks.map((link) => (
                  <li key={link.href}>
                    <Link href={resolveHref(link.href, basePath)} className="rmp-footer-link">
                      {link.label}
                    </Link>
                  </li>
                ))}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", marginTop: "1.25rem" }}>
              <a
                ...
                className="rmp-footer-link rmp-footer-social"
              >
        ...
        >
          <div style={{ display: "flex", gap: "1.5rem" }}>
            <Link href="/privacy" className="rmp-footer-fine">Privacy Policy</Link>
            <Link href="/terms" className="rmp-footer-fine">Terms &amp; Conditions</Link>
          </div>
          <p className="rmp-footer-fine" style={{ margin: 0 }}>
      ...
      <style>{`
        ...
        .rmp-footer-link:hover { opacity: 1; }
        .rmp-footer-social {
          display: inline-flex;
          align-items: center;
          gap: 6px;
